...
-- SAMPLE SQL QUERIES
-- Query 1
-- creates a view to display the names of blood donors and recipients who share the same blood group and were registered on the same date.
...
-- Query 2
-- This query retrieves information about blood specimens that are associated with a specific disease and are currently active or have a positive status. Specifically, it tells you the specimen number and blood group of blood samples 
...
select BB_Manager.M_id, mName,Recipient.reci_name, Recipient.reci_Brgp, BloodSpecimen.b_group
from BB_Manager,
    Recipient,
    BloodSpecimen
